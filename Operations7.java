...
public class Operations7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text = (TextView)findViewById(R.id.titleo7);
        next = (Button)findViewById(R.id.nexto7);
        back = (Button)findViewById(R.id.backo7);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(Operations7.this,Operations8.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent3 = new Intent(Operations7.this,Operations6.class);
