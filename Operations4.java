...
public class Operations4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_operations4);

        text = (TextView)findViewById(R.id.titleo4);
        next = (Button)findViewById(R.id.nexto4);
        back = (Button)findViewById(R.id.backo4);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(Operations4.this,Operations5.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent3 = new Intent(Operations4.this,Operations3.class);
