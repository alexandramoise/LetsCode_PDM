...
public class Operations8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text = (TextView)findViewById(R.id.titleo8);
        next = (Button)findViewById(R.id.nexto8);
        back = (Button)findViewById(R.id.backo8);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(Operations8.this,Operations9.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent3 = new Intent(Operations8.this,Operations7.class);
