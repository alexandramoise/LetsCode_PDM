...
public class Introduction10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_introduction10);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(Introduction10.this,Introduction11.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent3 = new Intent(Introduction10.this,Introduction9.class);
        ...
        text = (TextView)findViewById(R.id.title10);
