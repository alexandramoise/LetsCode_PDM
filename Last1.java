...
public class Last1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text = (TextView)findViewById(R.id.titlel1);
        next = (Button)findViewById(R.id.nextl1);
        back = (Button)findViewById(R.id.backl1);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(Last1.this,Last2.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent3 = new Intent(Last1.this,Profil.class);
