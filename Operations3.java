...
public class Operations3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_operations3);

        text = (TextView)findViewById(R.id.titleo3);
        next = (Button)findViewById(R.id.nexto3);
        back = (Button)findViewById(R.id.backo3);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(Operations3.this,Operations4.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent3 = new Intent(Operations3.this,Operations2.class);
