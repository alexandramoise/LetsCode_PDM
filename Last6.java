...
public class Last6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_last6);

        text = (TextView)findViewById(R.id.titlel6);
        next = (Button)findViewById(R.id.nextl6);
        back = (Button)findViewById(R.id.backl6);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(Last6.this,Quiz3.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent3 = new Intent(Last6.this,Last5.class);
