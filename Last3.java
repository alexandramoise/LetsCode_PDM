...
public class Last3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text = (TextView)findViewById(R.id.titlel3);
        next = (Button)findViewById(R.id.nextl3);
        back = (Button)findViewById(R.id.backl3);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(Last3.this,Last4.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent3 = new Intent(Last3.this,Last2.class);
